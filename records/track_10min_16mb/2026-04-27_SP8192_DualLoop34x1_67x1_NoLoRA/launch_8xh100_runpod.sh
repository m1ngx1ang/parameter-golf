...
RECORD_DIR="${RECORD_DIR:-records/track_10min_16mb/2026-04-27_SP8192_DualLoop34x1_67x1_NoLoRA}"
...
RUN_NAME="${RUN_NAME:-sp8192-dualloop34x1-67x1-nolora-${RUNPOD_GPU_COUNT}xh100-$(date -u +%Y%m%d-%H%M%S)}"
