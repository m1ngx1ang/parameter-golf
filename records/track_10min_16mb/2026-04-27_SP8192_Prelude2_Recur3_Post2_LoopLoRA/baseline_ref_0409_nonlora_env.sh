...
export RECUR_DEPTHS="${RECUR_DEPTHS:-2,3,4}"
export RECUR_DEPTH_EVAL="${RECUR_DEPTH_EVAL:-3}"
export ENCODED_LN_ENABLED="${ENCODED_LN_ENABLED:-1}"
...
export RECURRENT_MLP_MULT="${RECURRENT_MLP_MULT:-4.0}"
...
export RECUR_INPUT_SCALE_INIT="${RECUR_INPUT_SCALE_INIT:-0.01}"
export RECUR_H0_FROM_ENCODED="${RECUR_H0_FROM_ENCODED:-1}"
export RECUR_BPTT_TAIL="${RECUR_BPTT_TAIL:-0}"
