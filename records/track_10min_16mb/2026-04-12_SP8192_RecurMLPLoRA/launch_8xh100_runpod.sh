...
lora_post_loop_env="MLP_LORA_RANK=${MLP_LORA_RANK:-4} MLP_LORA_ALPHA=${MLP_LORA_ALPHA:-4.0} MLP_LORA_LAYERS=${MLP_LORA_LAYERS:-} LOOP_SETTLE_FRAC=${LOOP_SETTLE_FRAC:-0.10} MLP_LORA_WARMUP_STEPS=${MLP_LORA_WARMUP_STEPS:-400} MLP_LORA_LR=${MLP_LORA_LR:-0.02} MLP_LORA_WD=${MLP_LORA_WD:-0.0}"
